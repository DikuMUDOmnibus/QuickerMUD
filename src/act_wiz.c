...
void do_mstat (CHAR_DATA * ch, char *argument)
{
    ...
    sprintf (buf,
             "Vnum: %d  Format: %s  Group: %d  Sex: %s  Room: %d\n\r",
    ...
    {
        sprintf (buf,
                 "modifies %s by %d for %d hours with bits %s, level %d.\n\r",
...
void do_mset (CHAR_DATA * ch, char *argument)
{
    ...
    if (arg1[0] == '\0' || arg2[0] == '\0' || arg3[0] == '\0')
    {
        ...
        send_to_char ("    group gold silver\n\r", ch);
        send_to_char ("    align thirst hunger drunk full\n\r", ch);
